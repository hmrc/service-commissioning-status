...
import uk.gov.hmrc.servicecommissioningstatus.model.{StringType, StringTypeParser}
...
object TeamsAndRepositoriesConnector {
  ...
  sealed trait ServiceType extends StringType
  object ServiceType extends StringTypeParser[ServiceType] {
  ...
  sealed trait Tag extends StringType

  object Tag extends StringTypeParser[Tag] {
